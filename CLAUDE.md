...
- [Design: gated DCR correction](docs/design_gated_dcr_correction.md) — **not implemented; lives on `gated-dcr-correction-design` until we decide to build it**
